...
const DetalleProducto = () => {
  ...
  return (
    <div>
      <button
        onClick={() => navigate(-1)}
        className="text-indigo-600 font-semibold hover:underline mb-6 cursor-pointer flex items-center gap-1"
      >
        <span>← Volver</span>
      </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex gap-3 mt-4 overflow-x-auto pb-2">
            {imagenes.map((img, idx) => (
              <button
                ...
                className={`rounded-lg overflow-hidden border-2 transition shrink-0 cursor-pointer ${idx === imagenActiva
                    ? "border-indigo-600"
        ...
        <div>
          ...
          <button
            ...
            className={`w-full md:w-auto px-10 py-4 rounded-lg font-bold transition shadow-md cursor-pointer ${agregado
      ...
      {lightboxAbierto && (
        ...
        >
          <button
            className="absolute top-5 right-5 text-white text-4xl hover:text-slate-300 transition cursor-pointer p-2"
            onClick={() => setLightboxAbierto(false)}
            aria-label="Cerrar"
          >
            ×
          ...
          <button
            ...
            className="absolute left-4 md:left-10 text-white text-4xl hover:text-indigo-400 transition cursor-pointer p-2"
            aria-label="Anterior"
          >
            ‹
          </button>
          ...
          <button
            ...
            className="absolute right-4 md:right-10 text-white text-4xl hover:text-indigo-400 transition cursor-pointer p-2"

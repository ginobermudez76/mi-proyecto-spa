  ...
  return (
    <div className="-m-4 sm:-m-6 lg:-m-8">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-700 via-purple-700 to-slate-900 text-white overflow-hidden">
        ...
        <div className="absolute -bottom-32 -right-24 w-[28rem] h-[28rem] bg-purple-500/30 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/catalogo"
              className="bg-white text-indigo-700 font-bold px-8 py-4 rounded-lg hover:bg-indigo-50 transition shadow-lg inline-block"
            >
            ...
            {user?.rol === "admin" && (
              <Link
                to="/mi-red"
                className="border-2 border-white/60 text-white font-bold px-8 py-4 rounded-lg hover:bg-white/10 transition inline-block"
              >
        ...
        {/* Indicador de scroll */}
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-indigo-200 animate-bounce pointer-events-none">
